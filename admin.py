...
class Detail(MethodView):
	...
	#TO DO:
	#handle slugs conflict
	if Post.objects.get(slug=form.slug.data):
		form.slug.data = form.slug.data + "_"
		current_app.logger.info(form.slug.data)
...
admin.add_url_rule('/admin/remove/<slug>/', view_func=Remove.as_view('delete'))
